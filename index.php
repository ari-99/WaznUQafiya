...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/uncak7iceokumpnygjknx7jj1mfysniqh98okllbgfy9mhor/tinymce/5/tinymce.min.js"
        ...
        <div class="inputs">
            ...
            <label id="rangeLbl">
                ...
                <input type="range" class="form-control-range" name="" min="1" value="1" id="rhymablility"
                    ...
                    oninput="rhymablilityVal.value = rhymablility.value"><output id="rhymablilityVal">1</output>
